...
exports.analyzeRootCause = void 0;
...
var analyzeRootCause = exports.analyzeRootCause = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(transaction) {
    var normalizedCause, errorCode, errorReason;
  ...
  return function analyzeRootCause(_x) {
